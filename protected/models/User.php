...
class User extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			array('username, password, passwordConfirm', 'required'),
			array('idProfile', 'numerical', 'integerOnly'=>true),
			array('username, password', 'length', 'max'=>75),
			...
			array('id, username, password, created, idProfile', 'safe', 'on'=>'search'),
		);
	}
	...
	public function relations()
	{
		...
		return array(
			'Profile' => array(self::BELONGS_TO, 'Profile', 'idProfile'),
		);
	}
